...
from fs_manager import fs_manager
...
class main_class:
    def __init__(self):
        logger.info('start financial statemnt doc parser program')
        self.load_config()
    ...
    def load_config(self):
        ...
        for data in range(start_year, end_year+1):
            self.bs_years.append(data)

    def start_parser(self):
        for data in self.corp_list:
            obj = fs_manager(data, list(reversed(self.bs_years)))
            obj.parse_fs()
            obj.parse_stock_cnt()
